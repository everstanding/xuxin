    ...
    <%@ include file="navbar.jsp" %>
        ...
        <div id="container-wrap">
                    ...
                    <div class="select-list">
                        ...
                        <div class="select-row">
                            ...
                            <ul class="label-list multi-labels" id="need-subject-select">
                                <!--                            <li class="my-label" data-id="">操作系统</li>-->
            ...
            <form action="/young/add_team" method="post" id="add_team">
                ...
                <input type="text" hidden="hidden" name="location" value="/young/projectTeam" >
            </form>
        </div>
...
<script src="${pageContext.request.contextPath}/web/js/main.js"></script>
        ...
        <script>
            $(document).ready(function() {
                //navbar act
                $("#global-top-navbar").find(".project-team").addClass("act").siblings().removeClass("act");
                //multi-select empty
                $(".multi-labels").empty();
            });
