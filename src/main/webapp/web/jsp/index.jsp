...
<div id="container-wrap">
    <div id="my-middle-container">
        ...
        <%--<div id="right-col">--%>
            ...
            <%--<ul class="ranking-list">--%>
                <%--<c:forEach items="${users}" var="user"    varStatus="id" >--%>
                    <%--<li class="rank-item">--%>
                        <%--<p class="number">${id.count}</p>--%>
                        <%--<p class="title">${user.uName}</p>--%>
                    <%--</li>--%>
                <%--</c:forEach>--%>
            <%--</ul>--%>
        <%--</div>--%>
        ...
        <div id="right-col-wrap">
            <!------------right-col--------------->
            <div id="right-col-user" class="right-col">
                <h3 class="rank-title">抢手用户</h3>
                <ul class="ranking-list">
                    <c:forEach items="${users}" var="user"    varStatus="id" >
                        <li class="rank-item">
                            <p class="number">${id.count}</p>
            ...
            <!------------right-col--------------->
            <div id="right-col-art" class="right-col">
                <h3 class="rank-title">最近活跃用户</h3>
                <ul class="ranking-list">
                    <c:forEach items="${usersRec}" var="user"    varStatus="id" >
                        <li class="rank-item">
                            <p class="number">${id.count}</p>
                            <img src="${user.uHeaderUrl}" class="portrait"/>
                            <p class="title">${user.uName}</p>
    ...
    <%--<!------------global-notice-modal-------------->--%>
    <%--<div class="modal fade" id="global-notice-modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="position:fixed;top:100px;">--%>
        <%--<div class="modal-dialog modal-sm" role="document">--%>
            <%--<div class="modal-content">--%>
                <%--<div class="modal-header">--%>
                    <%--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>--%>
