...
function ptuiCB(t, e, i, n, o, p) {
    ...
    var s = $("p"), a = !(!pt.plogin.at_account || !s.value && !pt.plogin.armSafeEdit.safepwd);
...
$.cookie = {
    ...
    if (void 0 === $.browser.info) {
        ...
        /webkit/.test(i) ? e = {type: "webkit", version: /webkit[\/ ]([\w.]+)/} : /opera/.test(i) ? e = {
            type: "opera",
    ...
    _counter: 0, _uid: function () {
        ...
        if ("object" != typeof t && (t = $(t)), document.addEventListener) t.addEventListener(e, i, !1); else if (document.attachEvent) {
            ...
            var o = {element: t, eventType: e, handler: i, wrappedHandler: n}, p = t.document || t, r = p.parentWindow,
                s = $.e._uid();
        ...
        if (document.addEventListener) t.removeEventListener(e, i, !1); else if (document.attachEvent) {
            var n = $.e._find(t, e, i);
            if (-1 == n) return;
    ...
    function e() {
        if (void 0 === n) if (window.localStorage) n = localStorage; else try {
            n = t(), n.load(o)
        } catch (t) {
            return n = !1, !1
        }
    ...
    return {
        decodeHtml: function (t) {
            ...
            var e = "";
            if ("undefined" != typeof JSON) e = JSON.stringify(t); else {
                var i = [];
    ...
    return {
        getComputedStyle: function (t) {
            ...
            if (window.getComputedStyle) var i = parseInt(window.getComputedStyle(t)[e]); else {
                ...
                var n = t.style.left, o = t.runtimeStyle.left;
            ...
            if (t.getBoundingClientRect && e.getBoundingClientRect) {
                var o = e.getBoundingClientRect(), p = t.clientTop || document.body.clientTop || 0,
            ...
            for (var i = t.className.split(" "), n = 0, o = i.length; n < o; n++) if (e == i[n]) return !0;
            return !1
    ...
    fade: function (t, e, i, n, o) {
        if (t = $(t)) {
            ...
            var i = i || 1, n = n || 20, s = window.navigator.userAgent.toLowerCase(), a = function (t) {
                var e;
                if (-1 != s.indexOf("msie")) {
        ...
        if (t = $(t)) {
            ...
            var i = i || 10, n = n || 20, r = function (t) {
                return {left: t.offsetLeft, top: t.offsetTop}
            }(t), s = {width: t.clientWidth, height: t.clientHeight, left: r.left, top: r.top}, a = [];
        ...
        var g = 100 / p, d = 0, h = setInterval(function () {
    ...
    isHttps: function () {
        ...
        for (var e = ["21001601", "21000110", "21000121", "46000101", "716027609", "716027610", "549000912", "637009801"], i = !0, n = 0, o = e.length; n < o; n++) if (e[n] == t) {
            i = !1;
            break
        }
        return i
    ...
    monitor: function (t, e) {
        ...
        var i = !1, n = "http://isdspeed.qq.com/cgi-bin/r.cgi?";
    ...
    }, speedPoints: {}, basePoint: {}, setBasePoint: function (t, e) {
    ...
    function $(t) {
        ...
        if (r-- > 0) for (s < this.DB && (i = this[r] >> s) > 0 && (o = !0, p = u(i)); r >= 0;) s < e ? (i = (this[r] & (1 << s) - 1) << e - s, i |= this[--r] >> (s += this.DB - e)) : (i = this[r] >> (s -= e) & n, s <= 0 && (s += this.DB, --r)), i > 0 && (o = !0), o && (p += u(i));
        return o ? p : "0"
    }
    ...
    function z(t, e) {
        ...
        for (o.copyTo(i); --p >= 0;) if (e.sqrTo(i, n), (t & 1 << p) > 0) e.mulTo(n, o, i); else {
            var a = i;
            i = n, n = a
        }
        return e.revert(i)
    ...
    function h(t, e) {
        var i = [];
        if (e) for (var n = 0; n < t.length; n++) i[n] = 255 & t.charCodeAt(n); else for (var o = 0, n = 0; n < t.length; n += 2) i[o++] = parseInt(t.substr(n, 2), 16);
        return i
    }
...
var __pt_ieZeroLogin = !1, __pt_webkitZeroLogin = !1;
pt.qlogin = function () {
    var t = {17: 2, 19: 3, 20: 2, 21: 3, 22: 3, 23: 3, 25: 3, 32: 3, 33: 3, 34: 3, 40: 2},
        e = {17: 240, 19: 300, 20: 240, 21: 360, 22: 360, 23: 300, 25: 300, 32: 360, 33: 300, 34: 300, 40: 240}, i = [],
        n = [], o = [], p = [], r = 0, s = 0, a = 9,
        ...
        c = 1, u = t[pt.ptui.style], g = e[pt.ptui.style], d = 1, h = null, f = [4300, 4302, 4304, 4306, 4308],
        _ = [4301, 4303, 4305, 4307, 4309], m = function (t) {
            function e() {
                $("qlogin_list").style.left = 1 == t ? r * o - d * n + "px" : (2 - d) * n - r * o + "px", ++r > p && window.clearInterval(i)
            }

            if (!(1 == t && d <= 1 || 2 == t && d >= c)) {
                var i = 0, n = $("qlogin_show").offsetWidth || g, o = 10, p = Math.ceil(n / o), r = 0;
            ...
            if (n.length = 0, !pt.plogin.isTim) {
                if ($.suportActive()) try {
                    ...
                    for (var o = i.GetArray("PTALIST"), p = o.GetSize(), r = 0; r < p; r++) {
                        var s = o.GetData(r), l = s.GetDWord("dwSSO_Account_dwAccountUin"),
                            c = s.GetDWord("dwSSO_Account_dwAccountUin"), u = "",
                            g = s.GetByte("cSSO_Account_cAccountType"), d = l;
                        if (1 == g) try {
                        ...
                        var b = s.GetDWord("dwSSO_Account_dwUinFlag"),
                            q = {uin: l, name: d, uinString: c, type: g, face: h, nick: f, flag: b, key: m, loginType: 2};
                        n.push(q)
                    }
            ...
            if (/windows/i.test(navigator.userAgent)) {
                ...
                w(t, 100, "ptui_pc_querystatus_CB", null, function () {
                    pt.qlogin.callQQProtect({
                        service: 104,
                        action: 3,
                        wparam: $.str.json2str({appid: "ptlogin", subappid: pt.ptui.pt_3rd_aid, qqnum: "123456", msgid: 1}),
                        callbackName: "ptui_qqprotect_querystatus_CB"
                    })
                })
            }
        }, q = "0", S = function (t, e, i, n) {
            ...
            if (pt.qlogin.PCMgrSession) {
                ...
                var p = {appid: "ptlogin", subappid: pt.ptui.pt_3rd_aid, qqnum: t, ActionString: pt.qlogin.PCMgrSession2};
            ...
            }), ptui_getst_CB.submitUrl = E({uin: t, pt_local_tk: "{{hash_clientkey}}"}))
        }, T = function (t, e) {
            ...
            if (t) {
                v();
                var e = y(t);
                if (null == e) pt.plogin.show_err(pt.str.qlogin_expire), $.report.monitor(231544, 1); else {
                    var i = E(e);
            ...
            var e = parseInt(t.getAttribute("type")), i = t.getAttribute("uin");
            switch (e) {
                case 1:
            ...
            if (t) {
                var e = t.getAttribute("uin"), i = $("mengban_" + e);
            ...
            var t = $("qlogin_list"), e = t.getElementsByTagName("a");
            e.length > 0 && (h = e[0])
        }, V = function () {
            try {
                h.focus()
            ...
            if (pt.plogin.loginState == pt.LoginState.QLogin) {
                var n = $("qlogin_list"), o = $("qr_area");
                if (o && n.removeChild(o), n.innerHTML = "", o && n.appendChild(o), 3 == e ? $.css.hide(o) : o.style.display = "", pt.plogin.isNewStyle) var s = i.length; else var s = i.length > 5 ? 5 : i.length;
                ...
                for (var h = "", f = 0; f < s; f++) {
                    var _ = i[f], m = $.str.encodeHtml(_.uinString + ""), v = $.str.encodeHtml(_.nick);
                    "" == $.str.trim(_.nick) && (v = m);
                    var y = _.flag, w = 4 == (4 & y), k = 5 == _.loginType, b = pt.plogin.dftImg;
                    if (3 == _.loginType) {
                        var o = $("qr_area");
                ...
                h = n.innerHTML + h, n.innerHTML = h, setTimeout(function () {
                    var o = $("qlogin_show").offsetWidth || g, p = pt.plogin.isMailLogin ? 93 : 100;
                    ...
                    var a = o;
                    if (pt.plogin.isNewStyle) var l = 1 == c ? a : a / u * s; else var l = 1 == c ? a : s * p;
                    n.style.width = l + "px", pt.plogin.isMailLogin && (n.style.width = l + 14 + "px");
                    for (var h = 0; h < s; h++) if (3 == i[h].loginType) {
    ...
    return function () {
        ...
        buildUnifiedQloginList: function (t, e) {
            r = void 0 === t ? 0 : t, s = e;
            var a = [], l = {};
            if (i.length = 0, pt.plogin.isNewQr && a.push({loginType: 3}), 1 == t || 2 == t) return p = a, void G();
            ...
            if ("1" == pt.ptui.enable_qlogin && !pt.plogin.isTim) for (var u in n) l[n[u].name] || l[n[u].uinString] || (a.push(n[u]), l[n[u].uinString] = n[u], i.push(n[u]));
            if ("1" == pt.ptui.enable_qlogin && !pt.plogin.isTim) for (var u in o) l[o[u].name] || l[o[u].uinString] || (a.push(o[u]), l[o[u].uinString] = o[u], i.push(o[u]));
            ...
            if (/windows/i.test(navigator.userAgent)) {
                ...
                if (e || $.cookie.set("_qpsvr_localtk", Math.random(), "qq.com"), e = $.cookie.get("_qpsvr_localtk")) {
                    switch (t.timeout || (t.timeout = 200), t.wparam || (t.wparam = ""), t.lparam || (t.lparam = ""), parseInt(t.service)) {
                        case 103:
                            var i = 1, n = pt.qlogin.QQProtectSession;
                            break;
                        case 104:
                        default:
                            var i = 0, n = ""
        ...
        fetchOnekeyListByGUID: function (t) {
            if (t) var e = "https://ssl.ptlogin2." + pt.ptui.domain + "/pt_fetch_dev_uin?r=" + Math.random() + "&pt_guid_sig=" + t; else {
            ...
            switch (parseInt(t)) {
                ...
                case 1:
                    ...
                    for (var o = 0; o < n.length; ++o) {
                        ...
                        n[o].style.top = s + 10 + "px", $.animate.animate2(n[o], {top: s + "px"}, 5), $.animate.fade(n[o], 100, 5)
                    }
                    break;
                case 2:
...
}(), pt.LoginState = {PLogin: 1, QLogin: 2, OneKeyLogin: 3}, pt.plogin = {
    account: "",
    at_account: "",
    uin: "",
    salt: "",
    ...
    low_login_isshow: !1,
    list_index: [-1, 2],
    keyCode: {UP: 38, DOWN: 40, LEFT: 37, RIGHT: 39, ENTER: 13, TAB: 9, BACK: 8, DEL: 46, F5: 116},
    ...
    cap_cd: 0,
    authTimes: 0,
    checkErr: {2052: "网络繁忙，请稍后重试。", 1028: "網絡繁忙，請稍後重試。", 1033: "The network is busy, please try again later."},
    ...
    isPwdFirst: function () {
        ...
        for (var i in t) if (e.hostname.match(t[i])) return !0;
    ...
    formFocus: function () {
        ...
        try {
            var e = t.u, i = t.p, n = t.verifycode;
    ...
    auth: function () {
        ...
        var t = pt.plogin.getAuthUrl(), e = $.cookie.get("superuin");
    ...
    initAuthInfo: function (t) {
        var e = $.cookie.get("uin").replace(/^o0*/, ""), i = $.str.utf8ToUincode($.cookie.get("ptnick_" + e)) || e;
    ...
    createEmailTips: function (t) {
        var e = pt.plogin.generateEmailTips(t), i = e.length, n = [], o = "";
    ...
    setUrl: function () {
        var t = pt.ptui.domain, e = $.check.isHttps() && $.check.isSsl();
    ...
    hideVipLink: function () {
        var t = $("vip_link2"), e = $("vip_dot");
        !t || !e || $.check.needVip(pt.ptui.appid) && "2052" == pt.ptui.lang || ($.css.addClass(t, "hide"), $.css.addClass(e, "hide"))
    },
    ...
    set_account: function () {
        var t = $.str.trim($("u").value), e = pt.ptui.appid;
    ...
    list_keydown: function (t, e) {
        var i = $("email_list"), n = $("u");
        1 == e && (i = $("combox_list"));
        var o = i.getElementsByTagName("li"), p = o.length;
        switch (t.keyCode) {
    ...
    domLoad: function (t) {
        if (!pt.plogin.hasDomLoad) {
            ...
            !pt.plogin.isTim && $.http.loadScript((pt.ptui.isHttps ? "https://ssl.captcha.qq.com/" : "http://captcha.qq.com/") + "template/TCapIframeApi.js?aid=" + pt.ptui.appid + "&rand=" + Math.random() + "&clientype=2&lang=" + pt.ptui.lang + "&apptype=2", function () {
                var t = $("newVcodeArea"), e = document.createElement("div"), i = document.createElement("div");
    ...
    gzipReport: function () {
        if ("1" == pt.ptui.gzipEnable || pt.ptui.isHttps || pt.plogin.isUIStyle) ; else {
    ...
    bindEvent: function () {
        var t = $("u"), e = $("p"), i = $("verifycode"), n = $("verifyimgArea"), o = $("login_button"),
            p = $("p_low_login_box"), r = $("q_low_login_box"), s = $("auth_low_login_box"), a = $("email_list"),
            l = ($("feedback_web"), $("feedback_qr"), $("feedback_qlogin"), $("close")), c = $("switcher_qlogin"),
            u = $("switcher_plogin"), g = $("uin_del"), d = $("bind_account"), h = $("cancleAuth"), f = $("authClose"),
            _ = $("auth_area"), m = ($("auth_low_login_enable"), $("qr_invalid"), $("goBack")), v = $("qr_img_box"),
            y = $("qrlogin_img"), w = $("qr_info_link"), k = $("qrswitch_logo");
    ...
    showNewVC: function () {
        ...
        })) : capRefresh({uin: pt.plogin.at_account, capcd: pt.plogin.cap_cd})
    },
    hideNewVC: function () {
    ...
    check: function (t) {
        ...
        if (pt.plogin.account != pt.plogin.lastCheckAccount && "" != pt.plogin.account) {
            ...
            var e = pt.ptui.appid, i = pt.plogin.getCheckUrl(pt.plogin.at_account, e);
        ...
        window.setTimeout(function () {
            try {
                var t = ["navigationStart", "unloadEventStart", "unloadEventEnd", "redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
                    e = {}, i = window.performance ? window.performance.timing : null;
                if (i) {
    ...
    crossMessage: function (t) {
        if (pt.plogin.isUIStyle && pt.plogin.uistyleCM(t), void 0 !== window.postMessage) window.parent.postMessage($.str.json2str(t), "*"); else if (pt.ptui.proxy_url) {
    ...
    __get_polling_url: function (t) {
        var e = pt.ptui.isHttps ? "https://ssl." : "http://", i = e + "ptlogin2." + pt.ptui.domain + "/" + t + "?";
    ...
    begin_qrlogin: function (t) {
        if (!pt.ptui.lockuin) {
            var e = $("qr_invalid"), i = $("qrlogin_img");
    ...
    showQrTips: function () {
        if (!pt.plogin.inTipsAnimate && !pt.plogin.isTim) {
            ...
            if (pt.plogin.inTipsAnimate = !0, pt.qlogin.hasNoQlogin()) if (pt.plogin.isMailLogin) {
                var o = i.right - 160 + 12;
                $.animate.animate("qrlogin_img", {left: o}, 10, 10, n)
            } else $.animate.animate("qrlogin_img", {left: pt.plogin.isNewStyle ? -55 : -30}, 10, 10, n); else n();
    ...
    hideQrTips: function () {
        pt.plogin.inTipsAnimate || pt.plogin.isTim || pt.plogin.isNewQr && (pt.plogin.inTipsAnimate = !0, window.clearTimeout(pt.plogin.hideQrTipsClock), $("qr_tips_menban").className = "", $.animate.fade("qr_tips_pic", 0, 10, 10, function () {
            pt.qlogin.hasNoQlogin() ? ($.css.hide($("qr_tips")), $.animate.animate("qrlogin_img", {left: 12}, 10, 10, function () {
                pt.plogin.inTipsAnimate = !1
    ...
    armSafeEdit: function () {
        function t() {
            ...
            }, 0), e.removeChild(s), o.style.backgroundPosition = "-130px -130px", pt.plogin.armSafeEdit.isSafe = !1; else {
                var t = $("safe_edit");
        ...
        var e = $("pwdArea"), i = $("p"), n = e.style.height;
        i.style.width = "208px";
        ...
        p = {position: "absolute", top: "2px", left: "1px"};
    ...
    onekeyVerify: function (t, e, i) {
        var n = $("onekey_verify"), o = $("ov_retry_wrap"), p = $("ov_retry"), r = $("ov_back"), s = $("p"),
