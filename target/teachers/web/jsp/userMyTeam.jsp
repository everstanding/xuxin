                ...
                <c:forEach items="${table}" var="team"    varStatus="id" >
                    <tr>
                        ...
                        <td>
                                ...
                                <button type="button" class="table-button" onclick="go_mate_info(${team.uId_mate})">队友</button>
                            <button type="button" class="table-button" ><a href="/team/${team.tId}/teamTaskMember" target="_blank">日历</a></button>
                        </td>
                    </tr>
                </c:forEach>
               <%-- <tr>
...
<script>
    $(document).ready(function() {
        ...
        $("#left-bar").find(".my-team-join").addClass("act").siblings().removeClass("act");
    });
